...
def handle_dispatch():
    def simulate_mission():
        route = [[12.9716, 77.5846], [12.9680, 77.5846], [12.9680, 77.5880], [12.9650, 77.5880], [12.9650, 77.5900]]
...
def handle_transport(data):
    ...
    def simulate_transport():
        if hospital == 'A':
            route = [[12.9650, 77.5900], [12.9650, 77.5940], [12.9716, 77.5940], [12.9716, 77.5950], [12.9780, 77.5950]]
        else:
            route = [[12.9650, 77.5900], [12.9650, 77.5950], [12.9600, 77.5950], [12.9600, 77.6000], [12.9550, 77.6000], [12.9550, 77.6050]]
        for i, pos in enumerate(route):
            is_last = (i == len(route) - 1)
            socketio.emit('live_tracking', {
                'location': pos,
